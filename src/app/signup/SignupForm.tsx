...
export function SignupForm() {
  ...
  const {
    googleLoading,
    githubLoading,
    handleSocialLogin: socialAuthHandleSocialLogin,
  } = useSocialAuth(supabase, setError);
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              variant="outline"
              className="cyber-button pixel-text w-full py-2 text-sm sm:text-base relative"
              onClick={() => socialAuthHandleSocialLogin("google")}
              disabled={loading || googleLoading || githubLoading}
            >
              {googleLoading ? (
                <div className="flex items-center justify-center gap-2">
            ...
            <Button
              ...
              variant="outline"
              className="cyber-button pixel-text w-full py-2 text-sm sm:text-base relative"
              onClick={() => socialAuthHandleSocialLogin("github")}
              disabled={loading || googleLoading || githubLoading}
            >
              {githubLoading ? (
                <div className="flex items-center justify-center gap-2">
